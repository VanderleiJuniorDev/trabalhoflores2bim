...
Descritivo: Desenvolva um programa que conte quantas palavras existem em uma
            string fornecida pelo usuário.
*******************************************************************************/

// Explicação: Este exercício recebe uma string e conta o número de palavras
// separadas por espaços. A implementação será desenvolvida pelo grupo.
